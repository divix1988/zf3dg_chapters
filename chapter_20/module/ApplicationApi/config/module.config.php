    ...
    'input_filter_specs' => array(
        ...
        'ApplicationApi\\V1\\Rpc\\Polls\\Validator' => array(
            0 => array(
                ...
                'name' => 'answer',
                'description' => 'tekstowa odpowiedź sondy',
                'field_type' => 'string',
                'error_message' => 'Brak przesłanej odpowiedzi',
            ),
            1 => array(
                'required' => true,
                'validators' => array(),
                'filters' => array(),
                'name' => 'csrf',
                'description' => 'pole csrf',
                'error_message' => 'Brak podanego pola csrf',
            ),
        ),
    ),
