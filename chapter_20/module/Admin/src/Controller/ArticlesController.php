...
class ArticlesController extends AbstractController {
   ...
   public function indexAction() {
    ...
    /** 
     * Shows the contents assigned to the page.
     *
     * @return void
     */
   ...
   public function addpageAction() {
      $form = new Form\AddPage($this->cmsObject->getPages());
   ...
   public function editpageAction() {
      ...
      $form = new Form\AddPageDetails($pageId, $this->cmsObject->getLanguageList());
      $pageForm = new Form\AddPage($this->cmsObject->getPages(), $this->cmsObject->getPageByID($pageId));
      $viewParams = [
          'addPageDetails' => $form,
      ...
      if ($this->getRequest()->isPost()) {
         if ($this->params()->fromPost('url')) {
            ...
            if ($pageForm->isValid()) {
               $this->cmsObject->updatePage($pageId, $pageForm->get('name')->getValue(), $pageForm->get('url')->getValue(), $pageForm->get('parent_id')->getValue());
    ...
    */
    public function editcontentAction() {
        ...
        $form = new Form\AddLangContent($contentId, $this->cmsObject->getLanguageList());
   ...
   public function unlinkcontentAction() {
    ...
    public function deleteallAction() {
        if (!$this->isGranted('super_admin')) {
            throw new UnauthorizedException('Dostęp tylko dla super administratorów.');
        }
