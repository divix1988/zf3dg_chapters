...
class UsersController extends AbstractController
{
    ...
    public function addAction()
    {
        ...
        $userForm->setValidationGroup('username');

        if (!$userForm->isValid()) {
            print_r($userForm->getMessages()); exit();
            return ['userForm' => $userForm];
        }
    ...
    public function editAction()
    {
        ...
        // get user data, if it doesn't exists, redirect back to the index
        try {
        ...
        // data are stored, redirect back to the users list
        return $this->redirect()->toRoute('users', ['action' => 'index']);
    }
